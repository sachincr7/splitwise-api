...
import { GetGroupExpensesController } from './controllers/get-group-expenses.controller';
...
@Module({
  controllers: [AddExpenseController, GetUserExpensesController, GetGroupExpensesController],
